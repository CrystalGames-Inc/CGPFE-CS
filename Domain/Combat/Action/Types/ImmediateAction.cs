...
public abstract class ImmediateAction : CombatAction
{
    public string Name { get; set; }
    public bool AttackOfOpportunity { get; set; }

    public ImmediateAction(string name, bool attackOfOpportunity) : base(name, ActionType.Immediate, attackOfOpportunity)
    {
        Name = name;
